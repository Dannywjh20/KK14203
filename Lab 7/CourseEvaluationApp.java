...
class FormPanel extends JPanel implements ActionListener, ItemListener {
      ...
      b_submit.addActionListener(new ActionListener(){  
         public void actionPerformed(ActionEvent e){  
            ...
            //call method   
        	 ...
        	 if(e.getSource()== b_submit && printOutput()) {
        		 
        		 JOptionPane.showMessageDialog(f,"Successfully Updated.","Submit",JOptionPane.NO_OPTION);
        		 writeInput();  
        	 }
   ...
   public boolean printOutput(){
      ...
      if(code_selection.equals("[Select]") || code_selection.equals("")){
    	name.setText("Name is not entered");
    	matric.setText("Matric no is not entered");
...
public class CourseEvaluationApp extends JFrame { 
	public static JFrame f = new JFrame("Evaluation");
	public static JMenuBar mb = new JMenuBar(); 
	// create a menu
	public static JMenu x = new JMenu("Menu"); 
  // create menuitems 
	public static JMenuItem m1 = new JMenuItem("View Data"); 
	public static JMenuItem Exit = new JMenuItem("Exit");  
	
	
	  public CourseEvaluationApp() {
 ...
 //    JMenuItem Exit = new JMenuItem("Exit");  
   //  m2.addActionListener((event) -> System.exit(0));
      CourseEvaluationApp cea = new CourseEvaluationApp();
